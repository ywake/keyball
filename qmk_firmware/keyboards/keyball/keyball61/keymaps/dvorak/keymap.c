...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DVOR] = LAYOUT_universal(
    ...
    _______  , _______  , MY_LCTL  , KC_LALT  , MY_LNG2  , MY_SPC   , MY_LNG1  ,            MY_ENT   , KC_BSPC  , _______  , _______  , _______  , TG(QWER) , _______
  ),
  ...
  [MOUSE] = LAYOUT_universal(
    ...
    _______  , KC_F12   , KC_F7    , KC_F8    , KC_F9    , _______  , _______  ,            _______  , _______  , KC_BTN1  , KC_BTN2  , KC_BTN3  , _______  , _______  ,
  ...
  [SYMBL] = LAYOUT_universal(
    ...
    _______  , _______  , KC_7     , KC_8     , KC_9     , _______  , _______  ,            _______  , _______  , _______  , KC_LBRC  , KC_RBRC  , _______  , _______  ,
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , KC_DEL   , _______  , _______  , _______  , _______  , _______
  ),
};
// clang-format on
